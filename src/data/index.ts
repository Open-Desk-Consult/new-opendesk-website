export const services = [
  ...
  },
  {
    ...
    icon: "/developer.svg",
    info: "We ensure that our clients have all the technical support that they need to run their operations seemlessly.",
  },
];

export const aboutOpendesk = [
  {
    title: "Mission",
    icon: "/mission.svg",
    info: "Our mission is to develop innovative, user-friendly applications and provide comprehensive support. We enhance our clients' digital presence with expertly crafted solutions that meet the highest standards",
  },
  {
    title: "Vision",
    icon: "/vision.svg",
    info: "Our vision is to be the leading technology company, recognized for elevating digital experiences through cutting-edge design and development solutions, fostering a culture of excellence and innovation",
  },
];
